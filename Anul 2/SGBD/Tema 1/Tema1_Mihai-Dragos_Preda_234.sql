-- 22 --
-- Eroare: daca tabelele care trebuie sterse nu exista.
-- Rezolvare: inainte sa le stergem, verificam daca tabelele exista sau nu.

-- 23 --
-- Folosim functia "Export" a aplicatiei SQL Developer (click dreapta pe tabel + Export)
-- Produce urmatorul output:
